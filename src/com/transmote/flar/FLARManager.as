...
import org.libspark.flartoolkit.FLARException;
	...
	public class FLARManager extends EventDispatcher {
        ...
        public function getThresholdBitmapData():BitmapData{
            if(this.markerDetector){
                return this.markerDetector.thresholdedBitmapData;
            } else {
                return null;
            }
        }

        public function getLabelingBitmapData():BitmapData{
            if(this.markerDetector){
                return this.markerDetector.labelingBitmapData;
            } else {
                return null;
            }
        }
		...
		private function checkForInitComplete () :void {
			...
			if (!this.thresholdAdapter) {
				this.thresholdAdapter = new HistogramThresholdAdapter();
			}
